...
:root {
  ...
  /* Weights in use: 400, 600 (sans); 400 italic not used; 600 (serif H1); Naskh 400 only (AR H1 + quotes; 700 dropped for NFR-1, 2026-09-22). Fonts subset by scripts/subset-fonts.sh. Figures: tabular (tnum) everywhere. */
