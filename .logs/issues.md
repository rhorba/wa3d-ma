...
- "An error occurred in next/font: Cannot read properties of null". Build depended on Google Fonts at build time: violates SDR-4/NFR-5 (build never touches the network). Fix: commit OFL font files, next/font/local.
